# ============================================================================
# Exercise 4.4 — Statistical Analysis
# ============================================================================
...
# TODO: generate 1000 samples from a normal distribution with mean=50, std=10
normal_samples = None  # replace None

# TODO: generate 1000 samples from a Poisson distribution with lambda=3
poisson_samples = None  # replace None

# TODO: generate 1000 samples from a Binomial distribution with n=10, p=0.4
binomial_samples = None  # replace None
...
iqr_val = None  # replace None

# TODO: create a boolean mask marking outliers (beyond 1.5 * IQR from Q1/Q3)
...
# TODO: compute z-scores of data
z_scores = None  # replace None

# TODO: create a boolean mask for |z| > 2.5 outliers
z_outlier_mask = None  # replace None
...
# TODO: run 2000 bootstrap iterations:
#       each iteration: resample 'sample' with replacement, compute mean
#       store all 2000 means in boot_means (shape: (2000,))
n_boot = 2000
boot_means = None  # replace None

# TODO: compute the 95% confidence interval (2.5th and 97.5th percentiles)
ci_lower = None  # replace None
ci_upper = None  # replace None
...
def main():
    ...
    # The 5 extreme outliers should be detected
    ...
    # True mean is 100 — CI should contain it with high probability
    assert ci_lower < 100. < ci_upper, \
        f"95% CI [{ci_lower:.1f}, {ci_upper:.1f}] should contain 100"

    print("Exercise 4.4 — All assertions passed!")
