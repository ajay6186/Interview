...
# TODO: create a vectorized version of clamp_scalar using np.vectorize
#       name it 'clamp_vec'
clamp_vec = None  # replace None
...
# TODO: compute the same result WITHOUT a loop (vectorized using np.where)
vectorized_result = None  # replace None
...
# TODO: create a ufunc from grade using np.frompyfunc (1 input, 1 output)
grade_ufunc = None  # replace None
...
# TODO: apply normalize_row along axis=1 (to each row)
normalized_rows = None  # replace None
...
def main():
    ...
    print("Exercise 3.2 — All assertions passed!")
