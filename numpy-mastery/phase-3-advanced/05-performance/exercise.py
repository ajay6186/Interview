...
# TODO: check if mat is C-contiguous (bool)
c_contig = None  # replace None

# TODO: create a Fortran-order copy of mat
mat_f = None  # replace None

# TODO: check if mat_f is Fortran-contiguous (bool)
f_contig = None  # replace None
...
# TODO: double every element IN-PLACE using *=
arr *= 2   # this is correct — no TODO needed
...
# TODO: use np.einsum to compute matrix multiply A @ B  ('ij,jk->ik')
einsum_matmul = None  # replace None

# TODO: use np.einsum to compute matrix-vector product A @ v  ('ij,j->i')
einsum_matvec = None  # replace None

# TODO: use np.einsum to compute the trace of A  ('ii->')
einsum_trace = None  # replace None

# TODO: use np.einsum to compute the outer product of v with itself  ('i,j->ij')
einsum_outer = None  # replace None
...
# TODO: use np.einsum to compute batch @ eye3 for all 4 matrices ('bij,jk->bik')
batch_mul = None  # replace None
...
# TODO: create a view that selects every 100th element (no copy)
strided_view = None  # replace None
...
def main():
    ...
    print("Exercise 3.5 — All assertions passed!")
