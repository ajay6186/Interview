...
total_mean = None  # replace None

# TODO: compute the maximum value in the entire array
total_max = None  # replace None

# TODO: compute the minimum value in the entire array
total_min = None  # replace None

# ---------------------------------------------------------------------------
# 2. Reductions along axes
# ---------------------------------------------------------------------------

# TODO: sum each column (axis=0), result shape (3,)
col_sums = None  # replace None

# TODO: sum each row (axis=1), result shape (3,)
row_sums = None  # replace None

# TODO: mean of each column (axis=0), result shape (3,)
col_means = None  # replace None

# TODO: max of each row (axis=1), result shape (3,)
row_maxes = None  # replace None
...
# TODO: compute the standard deviation (population std, ddof=0)
std_val = None  # replace None

# TODO: compute the variance (population variance, ddof=0)
var_val = None  # replace None
...
# TODO: compute cumulative sum of seq
cum_sum = None  # replace None

# TODO: compute cumulative product of seq
cum_prod = None  # replace None
...
# TODO: compute square root of each element
sqrt_vals = None  # replace None

# TODO: compute e^x for x = [0, 1, 2] — use np.array([0, 1, 2])
exp_vals = None  # replace None

# TODO: compute natural log of values (values are all > 0)
log_vals = None  # replace None
...
def main():
    ...
    print("Exercise 1.5 — All assertions passed!")
