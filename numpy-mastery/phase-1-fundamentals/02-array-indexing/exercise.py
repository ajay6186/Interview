...
first = None  # replace None

# TODO: get the last element using a negative index
last = None  # replace None

# TODO: get elements at index 2, 3, 4 (a slice)
middle_slice = None  # replace None

# TODO: get every other element (step=2)
every_other = None  # replace None

# TODO: reverse the array using slicing
reversed_arr = None  # replace None
...
# TODO: get the element at row 1, column 2 (value = 7)
elem_1_2 = None  # replace None

# TODO: get the entire second row (index 1) as a 1D array
row1 = None  # replace None

# TODO: get the entire third column (index 2) as a 1D array
col2 = None  # replace None

# TODO: get the top-left 2x2 sub-matrix
submatrix = None  # replace None

# TODO: get the last two rows and last two columns
corner = None  # replace None
...
# TODO: get the element at position [1, 2, 3]
elem_3d = None  # replace None

# TODO: get the second "sheet" (first axis index 1) — shape should be (3,4)
sheet1 = None  # replace None
...
# TODO: create a VIEW of elements index 1–3
view_slice = None  # replace None

# TODO: create a COPY of elements index 1–3
copy_slice = None  # replace None
...
def main():
    ...
    print("Exercise 1.2 — All assertions passed!")
