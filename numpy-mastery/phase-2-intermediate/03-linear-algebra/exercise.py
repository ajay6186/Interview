...
# TODO: compute A @ B using the @ operator
AB = None  # replace None

# TODO: compute A @ B using np.matmul
AB_matmul = None  # replace None

# TODO: compute the dot product of the first row of A with the first column of B
dot_val = None  # replace None  # scalar
...
# TODO: compute the determinant of M
det_M = None  # replace None

# TODO: compute the inverse of M
inv_M = None  # replace None
...
# TODO: solve A_sys @ x = b_sys using np.linalg.solve
x_solution = None  # replace None
...
# TODO: compute the trace of C (sum of diagonal elements)
trace_C = None  # replace None

# TODO: compute the Frobenius norm of C
frob_norm = None  # replace None

v = np.array([3., 4.])

# TODO: compute the L2 (Euclidean) norm of vector v
l2_norm = None  # replace None
...
# TODO: compute P @ P (P squared)
P_squared = None  # replace None
...
def main():
    ...
    print("Exercise 2.3 — All assertions passed!")
