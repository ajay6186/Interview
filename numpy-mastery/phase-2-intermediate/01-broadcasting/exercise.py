...
# TODO: add row_vec to every row of matrix
add_row = None  # replace None

# TODO: add col_vec to every column of matrix
add_col = None  # replace None
...
# TODO: compute the mean of each row, shape (3, 1)
row_mean = None  # replace None

# TODO: compute the std of each row (ddof=0), shape (3, 1)
row_std = None  # replace None

# TODO: normalize: (data - row_mean) / row_std
normalized = None  # replace None
...
# TODO: compute the outer product using broadcasting (no np.outer)
#       reshape a to (4,1) and multiply by b (shape (3,)) → result (4,3)
outer = None  # replace None
...
# TODO: compute pairwise squared Euclidean distances using broadcasting
#       Hint: diff = points[:, np.newaxis, :] - points[np.newaxis, :, :]
#       Then sum of squares along last axis. Result shape: (3, 3)
dist_sq = None  # replace None
...
# TODO: use np.broadcast_to to create a (4, 3) view of template
broadcast_view = None  # replace None
...
def main():
    ...
    print("Exercise 2.1 — All assertions passed!")
